...
Building the virtual machine is this easy:
    ...
    host $ git clone https://github.com/harsshs/sparkway_rails_dev_box.git
    host $ cd sparkway_rails_dev_box
    host $ vagrant up
...
Just clone your project fork into the rails-dev-box directory on the host computer:

    host $ ls
    README.md   Vagrantfile puppet
    host $ git clone git@github.com:<your username>/project.git
...
Install gem dependencies in there:
    ...
    vagrant@rails-dev-box:/vagrant/<project>$ bundle
